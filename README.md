...
| Stage | Status | What |
|-------|--------|------|
| 1. Core | in progress | Scene→GPU sync, BVH, G-buffer, traced shadows + 1-bounce GI, accumulation |
| 2. Reprojection | — | Motion vectors + history reprojection: keep samples while moving (real-time unlock) |
