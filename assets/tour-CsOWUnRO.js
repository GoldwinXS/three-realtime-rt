import{R as _e}from"./RealtimeRaytracer-DP4_Ai5X.js";const Je="0.15.0",Ze=`
...
`,B={chip:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="6" y="6" width="12" height="12" rx="1"/><path d="M9 1v3M15 1v3M9 20v3M15 20v3M1 9h3M1 15h3M20 9h3M20 15h3"/></svg>',layers:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2 2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>',bulb:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18h6M10 22h4M12 2a7 7 0 0 0-4 12.7c.6.6 1 1.4 1 2.3h6c0-.9.4-1.7 1-2.3A7 7 0 0 0 12 2z"/></svg>',cube:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2 3 7v10l9 5 9-5V7l-9-5zM3 7l9 5 9-5M12 12v10"/></svg>',down:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 4v14M6 12l6 6 6-6"/></svg>',burst:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2v4M12 18v4M2 12h4M18 12h4M5 5l3 3M16 16l3 3M19 5l-3 3M8 16l-3 3"/></svg>',reset:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 12a9 9 0 1 0 3-6.7L3 8m0-5v5h5"/></svg>',sliders:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M3 12h18M3 18h18"/></svg>',chevD:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 9l6 6 6-6"/></svg>',frame:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>'};function a(t,n,r){const i=document.createElement(t);return n&&(i.className=n),r!=null&&(i.innerHTML=r),i}function H(t,n,r,i){const d=a("div","row"),u=a("label",null,t),b=a("label","sw"),s=a("input");s.type="checkbox",s.checked=n,s.addEventListener("change",()=>r(s.checked)),b.append(s,a("span","track"),a("span","knob"));const m="t"+Math.random().toString(36).slice(2,7);return u.setAttribute("for",m),s.id=m,d.append(u,b),i&&(d.title=i),{row:d,input:s}}function I(t,n,r,i,d,u,b,s){const m=a("div","row"),k=a("label",null,t),l=a("input");l.type="range",l.min=n,l.max=r,l.step=i,l.value=d;const w=a("span","val",u(d));return l.addEventListener("input",()=>{b(parseFloat(l.value)),w.textContent=u(parseFloat(l.value))}),m.append(k,l,w),s&&(m.title=s),{row:m,input:l,val:w,set(S){return parseFloat(l.value)===S?!1:(l.value=S,w.textContent=u(S),!0)}}}function et(...t){return I(...t).row}function ee(t,n,r,i,d){const u=a("div","row"),b=a("label",null,t),s=a("select");for(const[m,k]of n){const l=a("option",null,m);l.value=k,String(k)===String(r)&&(l.selected=!0),s.append(l)}return s.addEventListener("change",()=>i(s.value)),u.append(b,s),d&&(u.title=d),{row:u,select:s}}const qe=[];function X(t,n,r=!0){const i=a("div","sec");return i.append(a("h3",null,`<span class="chev">${B.chevD}</span>${t} ${n}`)),i.classList.toggle("collapsed",r),i.querySelector("h3").addEventListener("click",()=>{if(i.classList.contains("collapsed"))for(const d of qe)d!==i&&d.classList.add("collapsed");i.classList.toggle("collapsed")}),qe.push(i),i}function nt(t,n,r=!1){return X(t,n,!r)}function at({rt:t,state:n,setFeature:r,setCanvasScale:i,canvasScale:d,initial:u={},hint:b="drag to orbit · scroll to zoom"}){document.head.append(a("style",null,Ze));const s=a("div");s.id="panel";const m=a("div","hd",`${B.chip}<b>three-realtime-rt</b><span class="tag">RT on</span>`),k=a("button","fold",B.sliders);k.title="open / close the control panel",k.addEventListener("click",()=>s.classList.toggle("min")),m.append(k),s.append(m),matchMedia("(max-width: 700px)").matches&&s.classList.add("min");const l=`v${Je}${t.specMRTSupported?"":" · no-mrt"}`,w=a("div");w.id="fps",w.textContent=`-- fps · ${l}`,document.body.append(w);let S=0,A=performance.now(),M=()=>{};(function e(){requestAnimationFrame(e),S++;const o=performance.now();M(),o-A>=500&&(w.textContent=`${(S*1e3/(o-A)).toFixed(0)} fps · ${l}`,S=0,A=o)})();const R={},L=new Set,f=(e,o,c,p,y)=>{const Z=H(o,c,Ke=>{L.add(e),p(Ke)},y);return R[e]={input:Z.input,apply:p},Z},z=(e,o,{auto:c=!1}={})=>{const p=R[e];return!p||c&&L.has(e)||p.input.disabled&&o||p.input.checked===o?!1:(p.input.checked=o,p.apply(o),!0)},v=X(B.layers,"Renderer",!0);let N=d;const h=t.canvasScaleHook;t.canvasScaleHook=e=>{N=e,h&&h(e)};const g=e=>{t.adaptiveQuality=e,de.input.checked=e,M(!0)},E=H("ray tracing",n.rtEnabled,e=>pe(e),"the raytraced pipeline — toggle off for plain rasterized three.js");v.append(E.row);const de=H("auto quality",t.adaptiveQuality,e=>g(e),"let the governor hold a frame-rate target by trading lighting res, canvas scale and denoise passes");v.append(de.row);const oe=a("div","note");oe.textContent="the AUTO rows are the governor's. It spends its free wins first (half-rate GI, ReSTIR GI), then lighting res in 5% steps down to 20%, and only then the canvas; it also sets denoise passes and fast lights. Changing any of those by hand switches this off.",v.append(oe);const he=H("denoise",t.denoise,e=>t.denoise=e,"the à-trous denoiser — smooths the noisy pre-convergence frames");v.append(he.row);const ue=H("TAA (anti-alias)",t.taa,e=>{t.taa=e,t.resetAccumulation()},"temporal anti-aliasing — accumulates across frames to settle edges");v.append(ue.row);const se=ee("resolution",[["100%",1],["85%",.85],["75%",.75],["62%",.62],["50%",.5]],d,e=>{g(!1),N=parseFloat(e),i(N)},"whole-canvas buffer scale — a browser-zoom-style lever with quadratic savings"),ne=ee("lighting res",[["100%",1],["75%",.75],["50%",.5],["37%",.375],["25%",.25]],t.renderScale,e=>{g(!1),t.renderScale=parseFloat(e)},"the resolution the lighting passes trace at — the first lever the governor spends"),fe=(e,o)=>{const c=a("span","gov hide","auto");return c.title=o,e.insertBefore(c,e.lastChild),c},Ue=fe(se.row,"driven by auto quality — the governor's deepest lever, taken only after lighting res bottoms out at 20%"),We=fe(ne.row,"driven by auto quality — the first resolution the governor spends, in 5% steps down to 20%");v.append(se.row,ne.row);const ge=ee("overscan",[["off",0],["5%",.05],["10%",.1]],t.overscan,e=>{t.overscan=parseFloat(e)},"render past the canvas edge and crop back, so camera-motion noise is born off-screen");v.append(ge.row);const be=ee("view",[["composite",0],["albedo",1],["normals",2],["irradiance",3],["world pos",4],["emissive",5],["specular",6],["bvh cost",7]],t.outputMode,e=>t.outputMode=parseInt(e,10),"debug views of the G-buffer and the lighting passes");v.append(be.row);const me=I("cost scale",32,512,16,Math.round(1/t.costScale),e=>`${Number(e).toFixed(0)} hits`,e=>t.costScale=1/e,"BVH traversal cost heatmap saturation, for the “bvh cost” view");v.append(me.row),s.append(v);const ve={absorption:[]};let G=null;const U=e=>{t.restir=e,xe.input.checked=e,e||(t.stochasticLights=!1,W.input.checked=!1),t.resetAccumulation()},j=new Set,ae=(e,o)=>{if(o){G===null&&(G={restir:t.restir,stochasticLights:t.stochasticLights}),j.add(e),t.restir&&U(!1);return}if(j.delete(e),j.size>0||!G)return;const c=G;G=null,c.restir!==t.restir&&U(c.restir),c.stochasticLights!==t.stochasticLights&&(t.stochasticLights=c.stochasticLights,W.input.checked=c.stochasticLights)},C=X(B.bulb,"Lighting & Atmosphere",!0);C.append(f("emissive","emissive area lights",t.emissiveNEE,e=>r("emissive",e)).row);const xe=f("restir","ReSTIR lights",t.restir,e=>{G=null,j.clear(),U(e)});C.append(xe.row);const F=e=>(e.classList.add("sub"),C.append(e),e),we=f("restirDirectionalBypass","sun bypass",t.restirDirectionalBypass,e=>{t.restirDirectionalBypass=e,t.resetAccumulation()},"keep DIRECTIONAL lights out of the reservoir and shade them exactly. The reservoir scores candidates UNSHADOWED, so it elects the sun everywhere and spends its one visibility ray on the wall between: interiors go black with bright specks. Costs one shadow ray per pixel.");F(we.row);const ye=f("restirReprojectionRescue","reprojection rescue",t.restirReprojectionRescue,e=>{t.restirReprojectionRescue=e,t.resetAccumulation()},"sub-texel correction plus a four-neighbour rescue when the reservoir's history fails its plane test. Without it, TAA jitter walks the sample across thin geometry and balusters/handrails/frames never accumulate any history at all.");F(ye.row);const ke=f("restirCandidateImportance","candidate importance",t.restirCandidateImportance,e=>{t.restirCandidateImportance=e,t.resetAccumulation()},"draw reservoir candidates by POWER (pool split, then that pool's CDF) instead of uniformly over lights + emissive triangles. Uniform spends ~91% of its candidates on the emissive pool, which carries ~4% of the light. Measured free.");F(ke.row);const Se=I("relative cap",0,4,.5,t.restirClampRel,e=>Number(e)===0?"off":Number(e).toFixed(1),e=>{t.restirClampRel=e,t.resetAccumulation()},"firefly cap on the ReSTIR direct term as a MULTIPLE of the pixel's own reservoir estimate of the light total (0 = the old absolute cap alone). One sample carries the whole sum, so an absolute cap clips the peaks and nothing lifts the zeros: bright surfaces converge dark.");F(Se.row);const Me=I("warm age",0,64,4,t.restirWarmAge,e=>Number(e)===0?"off":Number(e).toFixed(0),e=>{t.restirWarmAge=e,t.resetAccumulation()},"shade any pixel with fewer than N frames of validated reservoir history by the EXACT per-light loop instead. Removes reveal speckle outright and costs 5-6x a ReSTIR frame on those pixels; measured 2.2x whole-frame in motion, which is why it ships off.");F(Me.row);const Re=I("multi-sample",1,4,1,t.restirSamples,e=>`${Number(e).toFixed(0)}x`,e=>{t.restirSamples=e,t.resetAccumulation()},"shade N reservoir winners per pixel (the pixel's own plus N-1 neighbours'), each with its own visibility ray, averaged. Sub-1/sqrt(N) because neighbouring reservoirs are correlated, and the shipped denoiser already removes most of what it buys.");F(Re.row);const Le=a("div","note");Le.textContent="these five are the reservoir being RIGHT rather than fast: four are on by default and cost either nothing or one ray. “warm age” is the exception, off because it is 2.2x the frame in motion.",C.append(Le);const W=f("stochasticLights","fast lights (1 ray)",t.stochasticLights,e=>{t.stochasticLights=e,g(!1),t.resetAccumulation()});C.append(W.row);const Ce=f("ambient","ambient / hemisphere",t.ambient,e=>{t.ambient=e,t.resetAccumulation()},"honour three's AmbientLight and HemisphereLight as an UNOCCLUDED flat term (no ray, no shadow). Not GI: nothing occludes it and nothing carries colour between surfaces.");C.append(Ce.row);const Te=H("volumetric light",t.volumetric.enabled,e=>{t.volumetric.enabled=e,t.resetAccumulation()});C.append(Te.row);const Ee=H("fog / haze",t.fog.enabled,e=>{t.fog.enabled=e,t.resetAccumulation()});C.append(Ee.row),C.append(et("density",.01,.12,.005,t.fog.density,e=>e.toFixed(2),e=>t.fog.density=e)),s.append(C);const x=X(B.burst,"Effects",!0);x.append(f("specular","PBR specular",t.specular,e=>{t.specular=e,t.resetAccumulation()},"the GGX specular term on the traced paths").row),x.append(f("gi","global illumination",t.gi,e=>r("gi",e),"one-bounce colour bleed — light bounces once and carries surface colour").row);const D=f("giHalfRate","half-rate GI (fast)",t.giHalfRate,e=>{t.giHalfRate=e,t.resetAccumulation()},"update the GI sample on alternate frames — roughly half the GI cost");D.row.classList.add("sub"),x.append(D.row);const V=f("restirGI","ReSTIR GI (exp)",t.restirGI,e=>{t.restirGI=e,t.resetAccumulation()},"reuse the 1-bounce GI sample across frames via reservoir resampling (experimental)");V.row.classList.add("sub"),x.append(V.row);const re=a("div","note");x.append(re),x.append(f("reflections","reflections",t.reflections,e=>r("reflections",e),"traced specular reflections — a real ray per pixel, not an environment map").row);const ie=f("refraction","refraction",t.refraction,e=>r("refraction",e),"traced glass paths — light bends through transmissive materials");x.append(ie.row);const Y=e=>{t.absorptionShadows=e,ae("tintedShadows",e),t.resetAccumulation()},T=f("tintedShadows","tinted shadows",t.absorptionShadows,Y);T.row.classList.add("sub","dim"),T.input.disabled=!0;const Q=a("div","note");Q.textContent="acts on the direct + emissive shadow rays, so it needs them: ReSTIR shades primary direct light with one BINARY visibility ray, and turning this on unchecks “ReSTIR lights” (and “fast lights” with it) so the tint actually reaches the floor. Turning it off puts both back.";const Ye=f("absorption","tinted glass",!!u.absorption,e=>{e&&!t.refraction&&(ie.input.checked=!0,r("refraction",!0)),r("absorption",e),T.row.classList.toggle("dim",!e),T.input.disabled=!e,Q.style.display=e?"":"none",!e&&T.input.checked&&(T.input.checked=!1,Y(!1));for(const o of ve.absorption||[])o(e)});x.append(Ye.row),x.append(T.row),Q.style.display="none",x.append(Q);const Ie=I("dispersion",0,.3,.01,t.dispersion,e=>Number(e).toFixed(2),e=>{t.dispersion=e,t.resetAccumulation()},"chromatic dispersion on the refracted term — the amount white light splits into colour");x.append(Ie.row);const K=a("div","note");K.textContent="the lamp's light REACHES the table through its shade, which is a shadow-ray effect: so this unchecks “ReSTIR lights” (and “fast lights” with it) for the same reason “tinted shadows” does, and puts both back when it goes off. The shade's own outward glow needs neither.",x.append(f("scattering","scattering (Kubelka-Munk)",!!u.scattering,e=>{e&&!t.refraction&&(ie.input.checked=!0,r("refraction",!0)),r("scattering",e),K.style.display=e?"":"none",ae("kmScattering",e)},"Kubelka-Munk subsurface scattering — light returns from inside a pigmented body").row),x.append(K),K.style.display="none",s.append(x);const q=X(B.chip,"Quality & Performance",!0),Ae=I("firefly clamp",1,8,.5,t.fireflyClamp,e=>Number(e).toFixed(1),e=>t.fireflyClamp=e,"clamp the bright speckle outliers that sparse sampling leaves behind");q.append(Ae.row);const Ne=I("history length",8,128,8,t.maxHistory,e=>Number(e).toFixed(0),e=>t.maxHistory=e,"how many frames of temporal history the converger keeps");q.append(Ne.row);const He=I("denoise passes",0,5,1,t.denoiseIterations,e=>Number(e).toFixed(0),e=>{t.denoiseIterations=e,g(!1)},"how many à-trous filter passes the denoiser runs");q.append(He.row);const P=H("motion vectors",t.motionVectors,e=>{t.motionVectors=e,t.resetAccumulation()},"reproject temporal history through each fragment's PREVIOUS screen position instead of through the camera alone. Camera-only reprojection is simply wrong for a moving mesh; a static scene renders identically either way.");t.motionVectorsSupported||(P.input.disabled=!0,P.row.classList.add("dim"),P.row.title="this GPU exposes fewer than 5 draw buffers, so the motion-vector attachment cannot be allocated; every stage stays on camera-only reprojection"),q.append(P.row),s.append(q);const Be=a("div","exhibits");s.append(Be);const le=a("div","reset-bar"),Ge=a("button",null,`${B.reset}<span>Reset to defaults</span>`),ze=()=>{const e=_e.DEFAULTS;for(const[o,c]of[["gi",e.gi],["emissive",e.emissiveNEE],["reflections",e.reflections],["refraction",e.refraction],["absorption",!1],["scattering",!1]]){const p=R[o];p&&(p.input.checked!==c&&(p.input.checked=c,p.apply(c)),L.delete(o))}T.input.checked&&(T.input.checked=!1,Y(!1)),G=null,j.clear(),U(e.restir);for(const o of["renderScale","overscan","denoise","denoiseIterations","taa","ambient","giHalfRate","restirGI","specular","dispersion","stochasticLights","restirWarmAge","restirDirectionalBypass","restirReprojectionRescue","restirCandidateImportance","restirClampRel","restirSamples","motionVectors","maxHistory","fireflyClamp","outputMode","costScale","targetFps"])t[o]!==e[o]&&(t[o]=e[o]);t.volumetric.enabled=e.volumetric.enabled,t.fog.enabled=!1,g(e.adaptiveQuality),N=1,i(1);try{sessionStorage.removeItem("rtTourSettings")}catch{}for(const[o,c]of[[Ce,t.ambient],[we,t.restirDirectionalBypass],[ye,t.restirReprojectionRescue],[ke,t.restirCandidateImportance],[P,t.motionVectors],[V,t.restirGI],[D,t.giHalfRate],[he,t.denoise],[ue,t.taa],[Te,t.volumetric.enabled],[Ee,t.fog.enabled]])o.input.checked=c;Se.set(t.restirClampRel),Me.set(t.restirWarmAge),Re.set(t.restirSamples),Ie.set(t.dispersion),Ae.set(t.fireflyClamp),Ne.set(t.maxHistory),me.set(Math.round(1/t.costScale)),ge.select.value=String(t.overscan),be.select.value=String(t.outputMode),M(!0),t.resetAccumulation()};Ge.addEventListener("click",ze),le.append(Ge);const Fe=a("div","note");Fe.textContent="the library's own constructor defaults: the correctness fixes on, the expensive paths (GI, volumetric, warm age) off, full canvas, auto quality on.",le.append(Fe),s.append(le);const _=a("div","stats-foot"),$e=a("div","stats");_.append($e);const Oe=a("div","stats links");Oe.innerHTML='<a href="./costs.html" title="what every feature above costs, per scene, measured">Feature costs</a> &middot; <a href="https://github.com/GoldwinXS/three-realtime-rt" target="_blank" rel="noopener">GitHub (MIT)</a> &middot; <a href="https://goldwinxs.itch.io/three-realtime-rt-supporter-pack" target="_blank" rel="noopener">Supporter pack</a>',_.append(Oe),s.append(_);const ce=a("div","panel-fade");s.append(ce);const J=()=>{ce.style.bottom=`${_.offsetHeight}px`;const e=s.scrollHeight-s.clientHeight>1,o=s.scrollTop+s.clientHeight>=s.scrollHeight-1;ce.classList.toggle("show",e&&!o)};s.addEventListener("scroll",J,{passive:!0}),new MutationObserver(J).observe(s,{subtree:!0,attributes:!0,attributeFilter:["class"]}),addEventListener("resize",J),J(),document.body.append(s);const $=a("div");$.id="hint",$.textContent=b,b||($.style.display="none"),document.body.append($);const Qe=e=>`${Math.round(e*100)}%`,je=(e,o)=>{const c=y=>Math.abs(parseFloat(y.value)-o)<1e-6;let p=[...e.options].find(c);if(!p){p=a("option","gov-val",Qe(o)),p.value=String(o);const y=[...e.options].find(Z=>parseFloat(Z.value)<o);e.insertBefore(p,y||null)}e.value!==p.value&&(e.value=p.value);for(const y of[...e.options])y.classList.contains("gov-val")&&y!==p&&y.remove()};let De={};M=e=>{const o={auto:!!t.adaptiveQuality,light:t.renderScale,canvas:N,passes:t.denoiseIterations,fast:!!t.stochasticLights,half:!!t.giHalfRate,rgi:!!t.restirGI,gi:!!t.gi,denoise:!!t.denoise};let c=e===!0;for(const y of Object.keys(o))o[y]!==De[y]&&(c=!0);if(!c)return;De=o,je(ne.select,o.light),je(se.select,o.canvas),He.set(o.passes),W.input.checked=o.fast,D.input.checked=o.half,V.input.checked=o.rgi,Ue.classList.toggle("hide",!o.auto),We.classList.toggle("hide",!o.auto),oe.style.display=o.auto?"":"none",D.row.classList.toggle("dim",!o.gi),V.row.classList.toggle("dim",!o.gi||!o.denoise||o.passes<1);const p=o.rgi?o.gi?!o.denoise||o.passes<1?"ReSTIR GI is resolved at the denoise stage: with the denoiser off (or 0 passes) it contributes nothing.":o.passes>3?`${o.passes} denoise passes: the widest à-trous taps raise the filter's own lattice. 3 or fewer is the measured range, with or without ReSTIR GI.`:"":"ReSTIR GI needs global illumination on — the pass is skipped without it.":"";re.textContent=p,re.style.display=p?"":"none"},M(!0);const Ve=[];function pe(e){n.rtEnabled=e,E.input.checked=e,m.querySelector(".tag").textContent=e?"RT on":"RT off";for(const o of Ve)o(e)}return pe(n.rtEnabled),u.absorption&&R.absorption.apply(!0),u.absorption&&u.tintedShadows&&(T.input.checked=!0,Y(!0)),u.scattering&&R.scattering.apply(!0),{panel:s,exhibits:Be,gateHooks:ve,borrowRestir:ae,setFeatureState:z,resetToDefaults:ze,isOn:e=>!!(R[e]&&R[e].input.checked),touched:L,setRtEnabled:pe,isRtEnabled:()=>!!n.rtEnabled,onRtEnabled:e=>Ve.push(e),setHint(e){$.textContent=e,$.style.display=e?"":"none"},setStats(e){$e.innerHTML=e}}}const O=[{id:"cornell",href:"./index.html",title:"Cornell box",blurb:"the reference room, one feature at a time"},{id:"museum",href:"./museum.html",title:"Museum",blurb:"every feature at once, in one lit room"},{id:"models",href:"./models.html",title:"Model scenes",blurb:"stock glTF, untouched, ray traced"}],te={prev:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M15 5l-7 7 7 7"/></svg>',next:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M9 5l7 7-7 7"/></svg>',ray:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 3l8 9 8-6"/><path d="M2 20h20"/><circle cx="11" cy="12" r="1.6" fill="currentColor" stroke="none"/></svg>',bars:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 20V10M10 20V4M16 20v-7M22 20H2"/></svg>'},tt=`
...
`;function rt({stopId:t,panel:n}){document.head.append(Object.assign(document.createElement("style"),{textContent:tt}));const r=Math.max(0,O.findIndex(h=>h.id===t)),i=O[r],d=O[r-1],u=O[r+1],b=document.createElement("div");b.id="tour";const s=document.createElement("button");s.className="rtsw",s.type="button",s.innerHTML=`${te.ray}<span class="lbl">ray tracing</span><span class="dot"></span>`;const m=s.querySelector(".lbl"),k=h=>{s.classList.toggle("on",h),m.textContent=h?"ray tracing: on":"ray tracing: off",s.title=h?"ray traced lighting — click for plain rasterized three.js":"plain rasterized three.js (shadow maps + ACES) — click for ray tracing"};s.addEventListener("click",()=>n.setRtEnabled(!s.classList.contains("on"))),n.onRtEnabled(k),k(n.isRtEnabled()),b.append(s);const l=document.createElement("div");l.className="nav";const w=(h,g)=>{const E=document.createElement("a");return E.className=g?"":"off",h==="next"&&g&&E.classList.add("next"),E.href=g?g.href:"#",E.innerHTML=h==="prev"?`${te.prev}<span>prev</span>`:`<span>next</span>${te.next}`,E.title=g?`${h}: ${g.title}`:`no ${h} stop`,E},S=document.createElement("span");S.className="stop",S.innerHTML=`<b>${i.title}</b><i>stop ${r+1} of ${O.length} · ${i.blurb}</i>`,l.append(w("prev",d),S,w("next",u)),b.append(l);const A=document.createElement("div");A.className="dots";for(const h of O){const g=document.createElement("a");g.href=h.href,g.title=h.title,h.id===t&&g.classList.add("cur"),A.append(g)}const M=document.createElement("a");M.className="costs",M.href="./costs.html",M.innerHTML=`${te.bars}<span>feature costs</span>`,M.title="what each feature costs, in ms and fps, measured per scene",A.append(M);const R=document.createElement("div");R.className="bar",R.append(s,l,A),b.append(R);const L=document.createElement("div");L.id="cue",L.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M5 9l-3 3 3 3M9 5l3-3 3 3M15 19l-3 3-3-3M19 9l3 3-3 3"/></svg><span>drag to orbit</span>',document.body.append(L);let f=!1;const z=()=>{f||(f=!0,L.classList.add("gone"),L.classList.remove("show"))};setTimeout(()=>{f||L.classList.add("show")},1500);let v=null,N=null;return addEventListener("pointerdown",h=>{v=h.clientX,N=h.clientY}),addEventListener("pointermove",h=>{v!=null&&Math.hypot(h.clientX-v,h.clientY-N)>6&&z()}),addEventListener("wheel",z,{passive:!0}),setTimeout(z,1e4),n&&n.panel&&new MutationObserver(()=>{n.panel.classList.contains("min")||z()}).observe(n.panel,{attributes:!0,attributeFilter:["class"]}),document.body.append(b),{root:b,stop:i}}const Pe="rtTourSettings",Xe=["denoise","denoiseIterations","taa","adaptiveQuality","renderScale","overscan","specular","gi","giHalfRate","restirGI","emissiveNEE","reflections","refraction","restir","stochasticLights","dispersion","fireflyClamp","maxHistory","outputMode","costScale"];function ot({rt:t,state:n,canvasScale:r,panel:i}){if(t)try{const d={canvasScale:r,rtEnabled:!!n.rtEnabled};for(const u of Xe)d[u]=t[u];d.fog={enabled:t.fog.enabled,density:t.fog.density},d.volumetric={enabled:t.volumetric.enabled},d.reveal=i?{absorption:i.isOn("absorption"),tintedShadows:i.isOn("tintedShadows"),scattering:i.isOn("scattering")}:{},sessionStorage.setItem(Pe,JSON.stringify(d))}catch{}}function it(){try{const t=sessionStorage.getItem(Pe);return t?JSON.parse(t):null}catch{return null}}function lt(t,n){if(!n)return{initial:{},canvasScale:null,rtEnabled:null};for(const r of Xe)(typeof n[r]=="number"||typeof n[r]=="boolean")&&(t[r]=n[r]);return n.fog&&(t.fog.enabled=!!n.fog.enabled,typeof n.fog.density=="number"&&(t.fog.density=n.fog.density)),n.volumetric&&(t.volumetric.enabled=!!n.volumetric.enabled),{initial:n.reveal||{},canvasScale:typeof n.canvasScale=="number"?n.canvasScale:null,rtEnabled:typeof n.rtEnabled=="boolean"?n.rtEnabled:null}}function ct(t){const n=()=>ot(t());addEventListener("pagehide",n),addEventListener("beforeunload",n)}export{B as I,lt as a,at as b,ee as c,rt as d,a as e,et as f,it as l,ct as p,nt as s,H as t};
