...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function tc(){return new gt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Io(),fragmentShader:`
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function nc(){return new gt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Io(),fragmentShader:`
